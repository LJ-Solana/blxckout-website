...
// =======
     ...
     const _init = useCallback(async () => {
      ...
      try {
        ...
        setslideData({
          NXDE: responses[0].data.nfts.filter( i => i.collectionName !== "Unknown").slice(0, 20),
          BLXCKOUT: responses[1].data.nfts.filter(i => i.collectionName !== "Unknown").slice(0,20),
          RANDOM : shuffle([
            ...responses[0].data.nfts.filter(i => i.collectionName !== "Unknown").slice(0,20),
            ... responses[1].data.nfts.filter(i => i.collectionName !== "Unknown").slice(0,20)
          ])
        })
      ...
      <div className="nftbg">
        <Layout>
            ...
            <div className='nftcenter text-white mt-4 overflow-v'>
              <div className="headingnfts">
                ...
                <p className='abel fw-light'>Blxckout Genesis collection. The gateway into the 'X' ecosystem. Building blockchain-enabled products and services such as data storage & tooling, while providing a great UX on the journey through web 3.0</p>
                  ...
                  <Slider className='py-4' {...slideN}>
                   {Children.toArray(slideData.BLXCKOUT.map((post)=> {
                      const { name , imageUrl, collectionName, collectionAddress, tokenAddress ,traits } = post; 
                      return(
                        <Row className='d-flex'>
                            <Col md={5} sm={12}>
                            <img src={imageUrl} className="nfticon w-100" alt="missing" />
                            </Col>
                            <Col md={7} sm={12}>
                                <div className=" ">
                                  <h2 className="fw-bold">{collectionName}</h2>
                                ...
                                <div className="socialnft">
                                  <div className="hash">
                                      ...
                                      <p className="fw-bold height01 f-14 mb-2 textPink">5.5 SOL</p>
                                    </div>
                                ...
                                <div className="w-95">
                                  <div className="slidercontent">
                                    {Children.toArray(traits.map(trait => (
                                      <div className="hash">
              ...
              <div className="headingnfts">
                ...
                <p className='abel fw-light'>Access to 3 x top spec RPC nodes in a highly redundant setting for 1 year. No monthly subscription. Can be used for building Solana products, sniping and botting. A product from BLXCKOUT.</p>
                  ...
                  {Children.toArray(slideData.NXDE.map((post)=> {
                  const { name , imageUrl, collectionName, collectionAddress, tokenAddress ,traits } = post; 
                  return(
                      <Row className='d-flex'>
                        <Col md={5} sm={12}>
          ...
          <div className="text-white longslide">
            ...
            <Slider {...settings}>
                 {Children.toArray(slideData.RANDOM.map((post)=> {
                  const { name , imageUrl, collectionName, collectionAddress, tokenAddress ,traits } = post; 
                  return(
                  <div>
                    <img src={imageUrl} className="w-100" alt="missing" />
                    <div className="d-flex pt-2 space-between ">
                      <div className="hash">
                        ...
                        <h6 className="fw-bold ">{collectionName}</h6>
                      </div>
                    ...
                    <div className="d-flex space-between ">
                      <div className="hash">
                        ...
                        <p className="fw-bold height08 f-14 mb-2">45</p>
                      </div>
